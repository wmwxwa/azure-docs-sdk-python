...
keywords: Azure, python, SDK, API, azure-eventhub-checkpointstoreblob-aio, event-hubs
ms.date: 02/12/2024
ms.topic: reference
ms.devlang: python
ms.service: event-hubs
---
# Azure EventHubs Checkpoint Store using Storage Blobs client library for Python - version 1.2.0a20240212001 
